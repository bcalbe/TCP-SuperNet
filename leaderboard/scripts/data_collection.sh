#!/bin/bash
export CARLA_ROOT="/data3/jiale/TCP/CARLA_0.9.10"
...
export CHECKPOINT_ENDPOINT=data_collect_town01_long_results.json
export SCENARIOS=leaderboard/data/scenarios/all_towns_traffic_scenarios.json
export SAVE_PATH=data/data_collect_town01_long_results/



/home/jiale/anaconda3/envs/TCP/bin/python3 ${LEADERBOARD_ROOT}/leaderboard/leaderboard_evaluator.py \
--scenarios=${SCENARIOS}  \
--routes=${ROUTES} \
